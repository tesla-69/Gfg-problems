<h2><a href="https://www.geeksforgeeks.org/problems/special-digits--170647/1?page=3&difficulty=Hard&status=unsolved&sortBy=submissions">Special Digits</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given 5 integers -&nbsp;<strong>N,A,B,C,D</strong>.<br>
